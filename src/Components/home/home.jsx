...
function Home() {
  ...
  return (
    <div className="hidescroll">
      ...
      <img
        id="cat"
        src="https://www.kasandbox.org/programming-images/misc/cat-walk.gif"
      />
      <Delay>
        {/* Dog walking GIF from: https://www.pinterest.com/pin/472526185902776354/ */}
        <img
          id="dog"
          src="https://c.tenor.com/ePjGbe3qxbYAAAAj/golden-retriever-walking.gif"
        />
      </Delay>

      <div className="homedrop">
        <Upload picupload={"homepics"} />
      </div>
    </div>
  );
}
